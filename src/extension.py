...
@knext.node(
    ...
    category="/Other Data Types/Text Processing/Mining",
)
...
class BERTopicNode:
    ...
    def execute(self, exec_context: knext.ExecutionContext, input_table):
        ...
        vectorizer_model = CountVectorizer(ngram_range=(1, 2), max_features=5000, min_df=1, max_df=1.0)
